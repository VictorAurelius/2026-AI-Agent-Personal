...
**Scope:** Tach rieng khoi AI Agent Social Automation project
...
2. Chay SQL schema:
   ```bash
   docker exec -i postgres psql -U postgres -d social_automation < novel-translation/sql/01-novel-schema.sql
   ```

3. Import workflow vao n8n:
   - Mo http://localhost:5678
   - Workflows -> Import -> `novel-translation/workflows/novel-translate.json`
   - Activate workflow
...
Xem `docs/glossary-xianxia.md` cho bang thuat ngu dich chuan.
