...
1. **Re-import workflows** in n8n UI:
   ...
   - Import workflows/n8n/content-generate.json
   - Delete old "WF2: Batch Generate"
   - Import workflows/n8n/batch-generate.json
